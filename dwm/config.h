...
static const char *fonts[]          = { "Menlo for Powerline:size=12" };
static const char dmenufont[]       = "Menlo for Powerline:size=12";
...
static const Rule rules[] = {
	...
	{ "Transmission-gtk",     "transmission-gtk",     "Transmission",   3,            1,           -1 },
